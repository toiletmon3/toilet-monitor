...
- **ציון משוקלל לכל תא שירותים (0-100, גבוה = גרוע)** — מבוסס 4 מדדים:
  ...
  - 3 רמות צבע: 🟢 תקין (<30) · 🟠 בעייתי (30-59) · 🔴 קריטי (60+)
  - מוצג בעמוד Analytics + מיוצא ל-PDF/Excel · API: `GET /analytics/restroom-scores`
