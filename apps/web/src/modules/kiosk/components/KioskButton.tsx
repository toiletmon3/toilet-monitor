...
export default function KioskButton({ icon: Icon, emoji, label, onPress, fullWidth, color = '#00E5FF' }: Props) {
  ...
  return (
    ...
    >
      {emoji ? (
        <span
          style={{
            fontSize: fullWidth ? '4rem' : '3.5rem',
            lineHeight: 1,
      ...
      <span
        ...
        style={{
          ...
          fontWeight: 500,
          direction: 'rtl',
          textShadow: pressed ? `0 0 12px ${rgba(0.5)}` : 'none',
